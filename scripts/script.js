...
function ans1() {
	...
	answer.textContent = "Step back and observe the situation for a few minuets. Wait to see if a parent arrives. If the animal is in immediate danger from a predator or is in the road, remove the baby and bring to a rescue center.";
} 
